const MAPS_API_KEY = process.env.REACT_APP_MAPS_API
const google = "https://maps.googleapis.com/maps/api/js?key=" + {MAPS_API_KEY} + "&libraries=places,geometry&solution_channel=GMP_QB_commutes_v1_c"
...
const Map = () => {
    ...
    const CONFIGURATION = {
        ...
        "mapOptions": {
            "center" : {
                "lat": 41.38663589999999,
                "lng": -72.89776859999999
            },
      ...
      function initDestinations() {
        ...
        for (const destination of configuration.initialDestinations) {
          ...
          placesService.getDetails(
              ...
              () => {
                console.error('Failed to retrieve places info due to ' );
              });
        }
      }
